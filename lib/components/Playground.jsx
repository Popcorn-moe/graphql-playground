...
var Playground = /** @class */ (function (_super) {
    ...
    function Playground(props) {
        ...
        _this.toggleSchemaReload = function () {
            _this.setState(function (state) { return (__assign({}, state, { autoReloadSchema: !state.autoReloadSchema })); });
        };
    ...
    Playground.prototype.initSubscriptions = function () {
        var _this = this;
        this.state.sessions.forEach(function (session) { return _this.setConnection(session); });
    };
